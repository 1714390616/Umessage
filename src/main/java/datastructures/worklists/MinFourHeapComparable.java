    ...
    public void add(E work) {
        ...
        if (size != 0) {
            ...
            while (indicator == false) {
                if (currIndex % 4 == 0) {
                    if (data[currIndex].compareTo(data[(currIndex / 4) - 1]) < 0) {
                    ...
                    if (data[currIndex].compareTo(data[currIndex / 4]) < 0) {
                        // Current data is less than its parent, keep swapping.
                        E currData = data[currIndex];
        ...
        while ((4 * currIndex) + 1 < size) {
            ...
            for (int i = 2; i <= 4; i++) {
                if (((4 * currIndex) + i) < size) {
                    ...
                    if (minData.compareTo(data[(4 * currIndex) + i]) > 0) {
            ...
            if (data[currIndex].compareTo(data[minIndex]) > 0) {
